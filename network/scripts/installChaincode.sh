...
echo "Installing chaincode on peer0.manufacturer.pharma-net.com ..."
installChaincode 0 'manufacturer' $VERSION
echo "Installing chaincode on peer0.distributor.pharma-net.com ..."
installChaincode 0 'distributor' $VERSION
echo "Installing chaincode on peer0.retailer.pharma-net.com ..."
installChaincode 0 'retailer' $VERSION
echo "Installing chaincode on peer0.consumer.pharma-net.com ..."
installChaincode 0 'consumer' $VERSION
echo "Installing chaincode on peer0.transporter.pharma-net.com ..."
installChaincode 0 'transporter' $VERSION

# Instantiate chaincode on the channel using peer0.manufacturer
echo "Instantiating chaincode on channel using peer0.manufacturer.pharma-net.com ..."
